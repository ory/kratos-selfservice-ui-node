...
do this is via
[ORY Kratos SelfService UI Node Example Discussions](https://github.com/ory/meta/discussions)
...
- I have a question. Where can I get
  [answers to questions regarding ORY Kratos SelfService UI Node Example?](#communication)
...
- **Helping with open issues.** We have a lot of open issues for ORY Kratos SelfService UI Node Example
...
Check out [ORY Kratos SelfService UI Node Example Discussions](https://github.com/ory/meta/discussions). This is a great place for
...
[docs](https://github.com/ory/kratos-selfservice-ui-node/tree/master/docs) folder. Generate API and
configuration reference documentation using `cd docs; npm run gen`.

For further instructions please head over to
[docs/README.md](https://github.com/ory/kratos-selfservice-ui-node/blob/master/README.md).
...
1. Ensure that each commit has a subsystem prefix (ex: `controller:`).
   [List of subsystem prefixes for Kratos SelfService UI Node Example](https://github.com/ory/ory/kratos-selfservice-ui-node/blob/master/.github/semantic.yml)
   (if applicable).
...
- Private harassment is also unacceptable. No matter who you are, if you feel
  ...
  member, please contact one of the channel ops or a member of the ORY Kratos SelfService UI Node Example
